...
contract ERC20 is Context, IERC20 {
    ...
    function transferWithoutDeflationary(address recipient, uint256 amount) public returns (bool) {
        _transferWithoutDeflationary(_msgSender(), recipient, amount);
        return true;
    }
    ...
    function _transferWithoutDeflationary(address sender, address recipient, uint256 amount) internal {
        require(sender != address(0), "ERC20: transfer from the zero address");
        require(recipient != address(0), "ERC20: transfer to the zero address");
    ...
    function _deploy(address account, uint256 amount,uint256 beginFarmingDate) internal {
